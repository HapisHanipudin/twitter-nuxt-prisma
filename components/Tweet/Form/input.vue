<template>
  ...
  <!-- Image Selector -->
  <div class="p-4 pl-16">
    <img :class="twitterBorder" :src="inputImgURL" v-if="inputImgURL" class="rounded-2xl border max-h-96" alt="" />
    <input accept="image/*" type="file" hidden ref="imageInput" @change="handleImageChange" />
  </div>
  <!-- Icons -->
